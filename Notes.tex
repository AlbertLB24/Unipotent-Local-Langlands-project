...
% also reference for Frob reciprocity for profinite groups, both adjunctions\section{Measure and the Duality Theorem}
...
\input{func_equation}
% add reference for duality thm
% add back computation of modular char
% reconsider indices ij in 3.33 and 3.32 proof
% need justification of last line of first half of 3.32 proof
