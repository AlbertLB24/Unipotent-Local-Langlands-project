...
\begin{proof}[Proof of Theorem \ref{thm:langcorr2}.]
    ...
    \begin{enumerate}[(1)]
        ...
        where the penultimate step follows from the fact that $\chi_1(x)=\phi(x)|x|^{1/2}$ and $\chi_2(x)=\phi(x)|x|^{-1/2}$. The second equality comes from Figure 1.
        \item Finally, if $\pi$ is reducible and $\nn\neq0$, then $\bm\pi^1(\chi\otimes\rho,V,\nn)=\chi\phi\cdot\St_G=\chi\bm\pi^1(\rho,V,\nn)$ and
        ...
        where in this last case we are keeping track of the nilpotent $\nn$ and $\rho_\nn(x)=\chi_1(x)=\phi(x)|x|^{1/2}$. The second equality comes from Figure 1.
    \end{enumerate}
